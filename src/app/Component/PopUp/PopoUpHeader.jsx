...
const PopUpHeader = () => {
	return (
		<div className="flex justify-between items-center py-4 px-4 bg-gray-100  border-gray-300 border-b-2  w-full">
			<div className="flex items-center gap-4">
				...
				<Image src={RightIcon} alt="RightIcon" width={4} height={8} />
				<p className="text-sm text-gray-700">FrontEnd Case</p>
			...
			<div className='flex items-center gap-4'>
				...
				<Image src={TimesIcon} alt="TimesIcon" width={10} height={10} />
			</div>
		</div>
	)
}
